...
int Tir();
void Deplace_Pisteur();
void Deplace_Monstre();
...
int main()
{
   ...
   {'*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*'}
    ...
    while (vie_Monstre > 0 || n_pisteur > 0)
    {
        ...
        change_ecran();
        Rapport_Pisteur(&pn_pisteur, T_Pisteur, Tab_Traces_Monstre, T_Affiche_Terrain, &vie_Monstre);
...
void Placement_Monstre(char Terrain[HAUTEUR][LARGEUR], int Tab_Monstre[HAUTEUR][LARGEUR],coord_Monstre *Point_Monstre)
{
    ...
    while (isOk == 0)
    {
        ...
        {
             srand(time(NULL));
            Monstre_x = 8;//(rand()%(RMAX_X)+1);
            Monstre_y = 8;//(rand()%(RMAX_Y)+1);
            i = Monstre_y;
            j = Monstre_x;
